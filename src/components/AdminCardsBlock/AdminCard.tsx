...
const AdminCard = ({subtitle, text, image, number}: ICard) => {
  return (
    <Styled.AdminCardsGrid>
      <div>
        <SubHeaderWithInput header={`${number} Card subtitle`} inputValue={subtitle} onChangeFunction={() => {}} limit={28} />
        <SubHeaderWithInput header="Text 5" inputValue={text} onChangeFunction={() => {}} limit={28} />
      </div>
