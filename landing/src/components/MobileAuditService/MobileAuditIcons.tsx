        ...
        <Styled.IconContainer>
            ...
            <Styled.IconItems>
                <Styled.IconItem ref={securityTestIconRef}>
                    <Image src={activeIcon === iconPositions[0].key?.text ? securityTestIconActive : securityTestIcon} alt='mobile application security test image' />
                </Styled.IconItem>
                <Styled.IconItem ref={encryptionDefinitionIconRef}>
                    <Image src={activeIcon === iconPositions[1].key?.text ? encryptionDefinitionIconActive : encryptionDefinitionIcon} alt='encryption definition image' />
                </Styled.IconItem>
                <Styled.IconItem ref={operatingSystemIconRef}>
                    <Image src={activeIcon === iconPositions[2].key?.text ? operatingSystemIconActive : operatingSystemIcon} alt='mobile app operating system image' />
                </Styled.IconItem>
                <Styled.IconItem ref={migrationAuditIconRef}>
                    <Image src={activeIcon === iconPositions[5].key?.text ? migrationAuditIconActive : migrationAuditIcon} alt='android/ios apps static image' />
                </Styled.IconItem>
                <Styled.IconItem ref={discoveringDataIconRef}>
                    <Image src={activeIcon === iconPositions[4].key?.text ? discoveringDataIconActive : discoveringDataIcon} alt='discovering data image' />
                </Styled.IconItem>
                <Styled.IconItem ref={appsStaticIconRef}>
                    <Image src={activeIcon === iconPositions[3].key?.text ? appsStaticIconActive : appsStaticIcon} alt='migration audi' />
                </Styled.IconItem>
            </Styled.IconItems>
        </Styled.IconContainer>
    );
