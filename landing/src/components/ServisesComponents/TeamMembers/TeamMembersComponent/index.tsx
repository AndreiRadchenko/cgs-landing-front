        ...
        if (is768px) {
            ...
            const handleScroll = () => {
                if (ScrollListRef.current) {
                    ...
                    const maxScrollHeight = ScrollListRef.current.scrollHeight - ScrollListRef.current.clientHeight;
                    const scrollPercentage = (scrollTop / maxScrollHeight) * 100;
                    const maxTop = is400px ? 110 : 128;
                    const calculatedTop = Math.min(scrollPercentage * (maxTop / 100), maxTop);
