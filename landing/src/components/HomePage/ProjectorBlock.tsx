          ...
          {!visibleContent ? (
            <Styled.ScreenBlock className={isMobile ? "mobile" : undefined}>
              <Styled.projectorLoaderBg
                className={isScrolled ? "isScrolled" : undefined}
              >
        ...
        >
          ...
          {!visibleContent ? (
            <Styled.ScreenWithLight>
              <Styled.Light src={light.src} alt="light" />
              <Styled.ScreenBlock>
                <Styled.projectorLoaderBg
                  className={isScrolled ? "isScrolled" : undefined}
                >
            ...
            <Styled.ScreenWithLight className={"newScreen"}>
              <Styled.Light
                className={"addOpacity"}
                src={light.src}
                alt="light"
              />
              <Styled.ScreenBlock className={"screenNew"}>
                <Styled.TextContent>
                  <Styled.Title>{data?.title}</Styled.Title>
                  <Styled.Text>{data?.text}</Styled.Text>
                  <GetEstimationButton
