  ...
  return (
    <Styles.AdminCvGrid>
      <div>
        ...
        {!!errors.image && !values.image && <Styled.ImageErrorBox />}
        <PhotoBlockDashed
          photo={values.image}
          deleteFlag={true}
                    ...
                    <Styled.BottomText className="portfolio-admin-description">
                      {getTextLengthWithoutTags(item.text) > 62 &&
                        !errors?.info?.content?.[idx] && (
                          <Styles.ErrorMsg className="infoText">
                ...
                <Styles.StackWrapper>
                  {values?.skills?.card[idx]?.stack?.map((stack, stackIdx) => (
                    ...
                    >
                      ...
                      {stackIdx !== 0 ? (
                        <Styles.DeleteStack
                          onClick={() => handleDeleteStack(idx, stackIdx)}
                        >
                          delete
                        </Styles.DeleteStack>
                      ) : null}
        ...
        <AdminBlockDropDown title="4 BLOCK (PROJECTS)">
          <Styles.FieldsWrapper>
            ...
            >
              ...
              >
                <path
                  d="M17.75 10.575H10.575V17.75H7.425V10.575H0.25V7.425H7.425V0.25H10.575V7.425H17.75V10.575Z"
                  fill="#F1EFED"
                />
              </svg>
            </Styles.AddProjectBtn>
